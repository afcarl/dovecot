#include "dmp/DmpContextualOneStep.h"
...
void  DmpContextualOneStep::train(const vector<Trajectory>& trajectories, const vector<MatrixXd>& task_parameters, string save_directory)
{
