/**
 * @file   runEvolutionaryOptimization.h
 * @brief  The runEvolutionaryOptimization functions header file.
 * @author Freek Stulp
 */
 ...
 * \param[in] distribution The initial parameter distribution
 ...
 */
void runEvolutionaryOptimization(CostFunction* cost_function, DistributionGaussian* distribution, Updater* updater, int n_updates, int n_samples_per_update, std::string save_directory=std::string(""),bool overwrite=false);
 ...
 * \param[in] overwrite Overwrite existing files in the directory above (default: false)
 */
void runEvolutionaryOptimization(Task* task, TaskSolver* task_solver, DistributionGaussian* distribution, Updater* updater, int n_updates, int n_samples_per_update, std::string save_directory=std::string(""),bool overwrite=false);
