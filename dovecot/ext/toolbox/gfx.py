...
colors = [bold, end,
          ...
          bblack, bred, bgreen, byellow, bblue, bpurple, bcyan, bgrey,
          iblack, ired, igreen, iyellow, iblue, ipurple, icyan, igrey,
          biblack, bired, bigreen, biyellow, biblue, bipurple, bicyan, bigrey,]
