...
setup(
    ...
    classifiers=[],
    package_data={'surrogates.vrepsim.objscene': ['vrep_center.ttt', 'vrep_calibrate.ttt', 'vrep_sphere.ttt', 'vrep_othercube.ttt',
                                                  'ar.ttt', 'ar_center.ttt', 'ar_center_sphere.ttt', 'ar_center_cylinder.ttt', 'ar_other_cube.ttt'],
